# Docker container for the "Data Science At The Command Line book"
#
#
...
RUN set -ex && \
	...
	perl \
  	perl-dev && \ 
    apk add --update perl-list-moreutils && \
    cd /tmp && git clone https://github.com/dkogan/feedgnuplot.git && \
    cd /tmp/feedgnuplot && perl Makefile.PL prefix=/usr/local && \
...
RUN Rscript -e 'install.packages("tidyr")' && \
   ...
   Rscript -e 'install.packages("peakedness")'
